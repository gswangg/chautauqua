...
- Wave-3..9+Campaign3+Waves2-5 (very compact): sub-apps/repos/ctx DEC-
  ...
  decisions/, src/decisions.ts. Wave6-9 (DEC-167..178): batteries drain
  LATE; W7/8 VOID dead stubs; W9 rebinds to task-w9-a.
- Wave10-14 (DEC-179..195, compact): CSV formula-escape; login-limiter
  failures-only; csrfFormOrHeader/logout; parseBoundedIdArray (64-
  char,1000 cap); DEC-187 .dev.vars via ensure-dev-vars.ts (never
  overwrite/read/print local). S'=7561cc1 VOIDED DEC-188 (real
  secret); S''=task-w12-a -> S'''=7f7477e (DEC-189 w13-a..f
  COOPERATIVE, dedupe by full heading '@ sha'); ports walkthrough
  8951/smoke 8952. 7f7477e battery hit 5/6, 4 real defects reopened
  exit (DEC-192/193 tracks+bulk chunking 500/batch stop-loudly+
  refetch; DEC-194 data-required DEC-008; DEC-191 email_log.contact_id
  nullable). DEC-195 VOID all 7f7477e once w14 merges.
- Wave 15 (DEC-196): w14 fixes merged (w14-b 64a4687/a a8c8c69/c
  1033d45). Battery S''''=1033d45, lanes w15-a build+test/b
  walkthrough@8951/c perf-smoke@8952/d render-sweep/e triage-
  closure(dep a)/f spec-audit. 6th-gen homonyms dead task-w15-a..k +
  VOID w12/13@7f7477e — match full heading '@ 1033d45'.
- Wave 16 (DEC-197): hold, ZERO tasks — battery 3/6 @1033d45; lanes
  c/d/e live; w15-a auth-limiter flake DISPOSITIONED non-blocking.
- Wave 17 (DEC-198): hold #2, ZERO tasks — 5/6 PASS @ 1033d45 on main
  (spec-audit/build+test/walkthrough/perf-smoke/render-sweep); w15-e
  triage-closure LIVE, verified-complete in working tree (detail file
  OPEN ITEMS: 0 / PASS @ 1033d45, uncommitted; branch @ d550885, zero
  commits). Wave 18: run DEC-197 4-pt checklist (tmp-main-check exempt
  non-task ref), declare iff all true; if w15-e still unlanded AND
  branch commit-less, presume dead — issue single log-only task-w18-a
  triage-closure @ 1033d45 w/OWN detail file, never overwrite w15-e
  artifacts, DEC-189 dedupe if w15-e lands meanwhile.
