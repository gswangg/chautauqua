// DEC-345: ported verbatim from app/src/pages/review/resultsSort.test.ts --
// sortResultsRows/sortValueForColumn moved into pure core (src/domain/
// evaluation.ts) so GET /api/v1/plans/:id/results can sort server-side.
import { describe, expect, it } from "vitest";
import { sortResultsRows, sortValueForColumn } from "../src/domain/evaluation";
import type { SortableResultsRow } from "../src/domain/evaluation";
