...
const LEDGER: LedgerEntry[] = [
  ...
  { file: "app/src/pages/settings/TracksRoomsPanel.tsx", verdict: "unpaged", reason: "tracks/rooms both use listPerPage (DEC-465); only `.length === 0` empty-state checks are rendered." },
