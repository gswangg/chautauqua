...
// a single prod failure because both EmailBindingMailer AND the route-level
...
// other write path (mail/dev-sink.ts, mail/email-binding.ts, and any future
// mailer) must go THROUGH that one writer, not around it.
