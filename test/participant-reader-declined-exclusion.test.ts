...
// DEC-773 wave-31 amendment (option 3b): `file.id = substr(contact.
// headshot_url, 12) and substr(contact.headshot_url, 1, 11) = '/headshots/'`
// — file.id referenced once, contact.headshotUrl referenced twice.
