...
const PARAMS_BY_PATH: Record<string, Record<string, string>> = {
  ...
  "/api/v1/tasks/:id/roster": { id: IDS.taskA },
  "/api/v1/tasks/:id/unassign": { id: IDS.taskA },
...
const CROSS_ORG_LEDGER: LedgerEntry[] = [
  ...
  { method: "GET", path: "/api/v1/tasks/:id/roster", expectedStatus: 404 },
  { method: "POST", path: "/api/v1/tasks/:id/unassign", expectedStatus: 404 },
