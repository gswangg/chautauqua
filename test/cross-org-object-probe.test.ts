...
const CROSS_ORG_LEDGER: LedgerEntry[] = [
  { method: "DELETE", path: "/api/v1/breaks/:id", expectedStatus: 403 },
  { method: "PATCH", path: "/api/v1/breaks/:id", expectedStatus: 403 },
  ...
  { method: "DELETE", path: "/api/v1/embeds/:id", expectedStatus: 403 },
  { method: "PATCH", path: "/api/v1/embeds/:id", expectedStatus: 403 },
  { method: "DELETE", path: "/api/v1/fields/:fieldId", expectedStatus: 404 },
  { method: "PATCH", path: "/api/v1/fields/:fieldId", expectedStatus: 404 },
  { method: "DELETE", path: "/api/v1/files/:fileId", expectedStatus: 403 },
  ...
  { method: "GET", path: "/api/v1/submissions/:id", expectedStatus: 403 },
  { method: "PATCH", path: "/api/v1/submissions/:id", expectedStatus: 403 },
  { method: "DELETE", path: "/api/v1/submissions/:id/slot", expectedStatus: 403 },
  { method: "PUT", path: "/api/v1/submissions/:id/slot", expectedStatus: 403 },
  { method: "GET", path: "/api/v1/submissions/:id/evaluations", expectedStatus: 403 },
  { method: "GET", path: "/api/v1/submissions/:id/files", expectedStatus: 403 },
  { method: "POST", path: "/api/v1/submissions/:id/files", expectedStatus: 403 },
  { method: "GET", path: "/api/v1/submissions/:id/history", expectedStatus: 403 },
  { method: "GET", path: "/api/v1/submissions/:id/revisions", expectedStatus: 403 },
  { method: "POST", path: "/api/v1/submissions/:id/revisions/:revisionId/restore", expectedStatus: 403 },
  { method: "POST", path: "/api/v1/submissions/:id/clone", expectedStatus: 403 },
  { method: "POST", path: "/api/v1/submissions/:id/content-note", expectedStatus: 403 },
  { method: "POST", path: "/api/v1/submissions/:id/content-status", expectedStatus: 403 },
  { method: "POST", path: "/api/v1/submissions/:id/participants", expectedStatus: 403 },
  { method: "PATCH", path: "/api/v1/submissions/:id/participants/:participantId", expectedStatus: 403 },
  ...
  { method: "DELETE", path: "/api/v1/tasks/:id", expectedStatus: 403 },
  { method: "PATCH", path: "/api/v1/tasks/:id", expectedStatus: 403 },
  { method: "GET", path: "/api/v1/tasks/:id/delete-preview", expectedStatus: 403 },
  { method: "POST", path: "/api/v1/tasks/:id/assign", expectedStatus: 403 },
  ...
  { method: "DELETE", path: "/api/v1/views/:id", expectedStatus: 403 },
];
