...
describe("formatEventDay (w1-i): the ONE public-surface day-heading/date-label formatter", () => {
  it("formats a 'YYYY-MM-DD' calendar day as a short weekday/month/day label", () => {
    expect(formatEventDay("2026-08-10")).toBe("Mon, Aug 10");
  });
  ...
  it("never re-interprets into a timezone (DEC-522: a calendar day, not an instant)", () => {
    ...
    expect(formatEventDay("2027-05-12")).toBe("Wed, May 12");
  });
