...
const LEDGER: Record<string, LedgerEntry> = {
  ...
  'pages/comms/TemplatesTab.tsx': { verdict: 'owed', reason: 'wave-55 ledger established; refusal-shapes test not yet written' },
  ...
  'pages/review/ProgressPanel.tsx': { verdict: 'owed', reason: 'wave-55 ledger established; refusal-shapes test not yet written' },
  'pages/review/ResultsTable.tsx': { verdict: 'owed', reason: 'wave-55 ledger established; refusal-shapes test not yet written' },
  'pages/review/ReviewerQueue.tsx': { verdict: 'owed', reason: 'wave-55 ledger established; refusal-shapes test not yet written' },
  'pages/review/Scorecard.tsx': { verdict: 'owed', reason: 'wave-55 ledger established; refusal-shapes test not yet written' },
