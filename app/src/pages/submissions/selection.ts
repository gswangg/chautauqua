/**
 * Row selection state for the submissions table: per-row checkboxes plus a
 * select-all-on-page checkbox. Selection is a set of submission ids and is
 * NOT cleared across pagination, so bulk actions can span multiple pages the
 * organizer has visited.
 */
