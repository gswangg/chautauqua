...
## 1. RESOLVED (wave 106, app/src/pages/review/Scorecard.tsx:498,508, app/src/styles.css:2302, app/src/App.tsx:474) — Neither reviewer-scorecard 390 frame draws a tab bar
...
`Scorecard.tsx:498` builds `phoneRegionDeclarations` (`{...(isPhone ?
{ 'data-chq-phone-dock': true, 'data-chq-phone-head': true } : {})}`),
spread onto the page root at `Scorecard.tsx:508`, opting the reviewer
scorecard into that contract,
