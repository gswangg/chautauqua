...
The two entries below were filed by task `v12m-w3-s` (wave 21), which claimed
the 7 **public** desktop frames in `Chautauqua Public and Portal.dc.html`
(:28, :132, :249, :680, :730, :779, :894 --
`test/desktop-frames-public.test.ts`).
