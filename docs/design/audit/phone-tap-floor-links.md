...
| `chq-btn-tertiary` | ROOMY | app/src/styles.css | Satisfied | Own phone rule at `styles.css:2406-2411` (`chq-btn-tertiary`). |
...
| `chq-comms-send-report-all-history` | ROOMY | app/src/pages/comms/comms.css | Satisfied | "All history ›" stands alone on its own line (`ComposeWizard.tsx:1573`); already floored at comms.css:2147 (`chq-comms-send-report-all-history`). |
...
| `chq-content-detail-action-link` | ROOMY | app/src/pages/content/content.css | Satisfied | Two right-flushed action links stacked against the title row, not sentence prose (`DeliverableDetail.tsx:371-375`); already floored at content.css:1641 (`chq-content-detail-action-link`). |
...
| `chq-content-version-download` | ROOMY | app/src/pages/content/content.css | Satisfied | Standalone Download action beside Delete in the version row's action cluster (`VersionList.tsx:143`); already floored at content.css:1326 (`chq-content-version-download`). |
...
| `chq-overview-deadline-cell` | ROOMY | app/src/pages/overview/overview.css | Satisfied | The `<Link>` itself wraps the whole grid cell (label + value), own tappable unit (`Overview.tsx:281`); floored at overview.css:473-477 (`chq-overview-deadline-cell`). |
...
| `chq-overview-toolbar-btn` | ROOMY | app/src/pages/overview/overview.css | Satisfied | Export / New-submission toolbar actions; floored at overview.css:503-508 (`chq-overview-toolbar-btn`). |
...
| `chq-pill` | ROOMY | app/src/styles.css | Satisfied | Phone floor at `styles.css:2403-2411` (`chq-pill`), shared with `chq-btn-tertiary`, `chq-rail-link`, `chq-checkbox-label`. |
