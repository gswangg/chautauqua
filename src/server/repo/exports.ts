...
import { DEC_017, DEC_027, DEC_055, DEC_258, DEC_529 } from "../../decisions";
 ...
 * in buildTable's JSON `records`). `fixedNames` defaults to the submissions
 * export's fixed columns (this helper's original caller); other exports
 * (e.g. evaluations, DEC-529) pass their own fixed column set. */
function nameCustomColumns(
  customFields: SubmissionCustomFieldColumn[],
  fixedNames: ReadonlySet<string> = FIXED_SUBMISSIONS_COLUMN_NAMES,
): string[] {
