...
export const DEC_013 = "Amendment (wave 108, mandate D21): the SWR read cache lives INSIDE the one API client and is opt-in per call site — apiGetCached/apiListCached, keyed on the exact request URL";
...
export const DEC_024 = "Amendment (wave 108, mandate D21): URL-keying IS event scoping, and that claim is proven by a ledger scan rather than assumed — no cached read may be event-varying without carrying the event id in its path";
