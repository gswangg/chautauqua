...
export const DEC_018 = "The plan editor at 390 is two lists, not a narrowed grid, with its save pair docked";
...
export const DEC_029 = "The portal's last two phone frames: Resources opens rather than downloads, and a rejected co-presenter is told what survived";
...
export const DEC_124 = "Amendment (wave 91): a descendant-scoped variant of an allow-listed SPA-only error selector needs its OWN allow-list row — an exemption never covers selectors it does not name";
