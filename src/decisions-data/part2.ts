...
export const DEC_383 = "Amendment (wave 99): A pointer-gesture prompt is not a phone control label: at 390 the affordance names the ACT, not the gesture";
export const DEC_384 = "The wave-3 render-sweep gate is log-only; its open items become wave-4 tasks, never in-lane patches";
export const DEC_385 = "Amendment (wave 99): A new page-local sheet is the legal way to keep a contended stylesheet from growing another owner; its phone block is its last top-level construct";
