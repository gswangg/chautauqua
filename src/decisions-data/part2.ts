...
export const DEC_385 = "Amendment (wave 103): a shadow can be load-bearing — a newly-winning phone declaration the frame contradicts is DELETED with the frame line as its receipt, never kept and never re-shadowed";
