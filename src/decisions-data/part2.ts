...
export const DEC_385 = "Amendment (wave 93): a two-sided cascade ratchet is re-measured and re-set by the lane that last touched a sheet";
...
export const DEC_393 = "Amendment (wave 93): the shared .chq-link-button gets a roomy phone variant; ink stays where the frame draws it";
