...
export const DEC_383 = "Amendment (wave 100): a token/palette guard that reads a stylesheet AS TEXT must strip comments before it judges — a frame-citation quote is documentation, not a declaration";
