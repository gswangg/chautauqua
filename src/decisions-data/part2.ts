...
export const DEC_265 = "Amendment (wave 110): an optimistic rollback reverts the one write that failed, never the snapshot it started from";
...
export const DEC_271 = "Amendment (wave 110): a recusal RETRACTS the score -- every downstream read anti-joins review_recusal, not just the queue";
...
export const DEC_367 = "Amendment (wave 111): a modifier that composes a floored base is exempt by comment; a real SSR control gets a real floor";
...
export const DEC_383 = "Amendment (wave 114): the auth input fill stays --chq-surface: the pack contradicts itself on #FFFFFF, and a self-contradicting frame demands nothing";
export const DEC_384 = "The wave-3 render-sweep gate is log-only; its open items become wave-4 tasks, never in-lane patches";
export const DEC_385 = "Amendment (wave 113): Every wave-9 phone rule is APPENDED inside the sheet's last max-width:700px block — never a new block, never an edit above it";
...
export const DEC_393 = "The row-action anchor tap-floor predicate credits inline-flex, base-rule padding, and the global cascade — 10 of its 64 offenders were false";
