...
export const DEC_383 = "Amendment (wave 93): the palette word-ban is tree-wide and binds synthetic test fixtures too";
export const DEC_384 = "The wave-3 render-sweep gate is log-only; its open items become wave-4 tasks, never in-lane patches";
export const DEC_385 = "Amendment (wave 94): One terminal phone block per sheet: a fix goes INSIDE the sheet's existing true-EOF max-width block, and byte-equivalent duplicate repair blocks collapse into it";
...
export const DEC_393 = "Amendment (wave 94): The tap-floor scan's `(no CSS rule)` bucket is a token-resolution artifact, and an `*-actions` container is exempted by naming the anchor rule that carries the floor";
