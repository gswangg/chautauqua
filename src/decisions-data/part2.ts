...
export const DEC_383 = "Amendment (wave 98): the palette closure's banned-word rule covers only files that can reach a rendered surface; *.test.ts/*.test.tsx are out of scope";
export const DEC_384 = "The wave-3 render-sweep gate is log-only; its open items become wave-4 tasks, never in-lane patches";
export const DEC_385 = "Amendment (wave 98): the terminal-phone-block contract gets ONE derived scan; per-sheet block-count pins are retired";
