...
export const DEC_894 = "Every headshot upload path runs the same dimension gate, WEBP included, and the organizer's Contacts drawer path thumbnails too (readImageDims learns the WEBP RIFF container)";
