...
export const agendaAndPublishing: DocsArticle = {
  ...
  standfirst:
    "You build the schedule by placing accepted sessions into rooms and time slots — by hand, by drag, or with auto-schedule — and the publish step controls what a visitor sees.",
  blocks: [
