...
export const yourSpeakerPortal: DocsArticle = {
  ...
  blocks: [
    ...
    {
      kind: "prose",
      text: "When the event accepts you, your task list turns on. It holds the items the organizer needs from you, each with a due date: a bio, a headshot, a signed agreement, slides. A task shows as open, then as completed once you finish it; an overdue task gets a flag, so you always know which ones are past their due dates.",
    },
    {
      kind: "figure",
